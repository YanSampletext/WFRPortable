...
const CACHE = 'ordo-v24';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/fonts.css',
  './css/base.css','./css/reskin.css','./css/marks.css','./css/ui-fixes.css',
  './js/storage-native.js','./js/dialogs.js','./js/app.js','./js/marks.js','./js/health.js','./js/collapse.js','./js/crit.js','./js/schemes.js','./js/diseases.js','./js/psych.js','./js/spells.js','./js/archive.js','./js/shell.js','./js/back-nav.js',
